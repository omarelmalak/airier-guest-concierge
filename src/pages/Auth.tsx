  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary relative overflow-hidden">
        ...
        <div className="absolute bottom-32 right-10 w-96 h-96 rounded-full bg-primary-foreground/5 blur-3xl" />
        
        <div className="relative z-10 flex flex-col justify-between p-12 text-primary-foreground">
          <Link to="/" className="flex items-center gap-2">
            <img src={airierLogo} alt="airier" className="h-10 brightness-0 invert" />
          </Link>
          
          <div className="space-y-6">
            <h1 className="text-4xl font-bold leading-tight">
              The short-term rental host that never sleeps.
            </h1>
            <p className="text-primary-foreground/80 text-lg">
              Automate guest communication with AI that knows your properties inside and out.
            </p>
          </div>
